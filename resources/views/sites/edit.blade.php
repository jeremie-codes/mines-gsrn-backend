                ...
                <form action="{{ route('sites.update', $site) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('code') is-invalid @enderror" 
                               id="code" name="code" value="{{ old('code', $site->code) }}" maxlength="3" 
                               style="text-transform: uppercase;" required>
                        <small class="text-muted">Attention: Modifier ce code affectera les futurs numéros d'adhésion</small>
                        @error('code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="alert alert-info">
                        <strong>Compteur de membres:</strong> {{ $site->membership_counter }}<br>
                        <small>Ce compteur s'incrémente automatiquement à chaque nouveau membre</small>
                    </div>
