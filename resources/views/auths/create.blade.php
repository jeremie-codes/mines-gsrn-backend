...
@section('title', 'Nouvelle Authentification - SMS Gateway')
@section('header', 'Créer une Nouvelle Authentification')

@section('content')
<div class="max-w-2xl mx-auto">
    <form method="POST" action="{{ route('auths.store') }}" class="space-y-6">
        @csrf
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Paramètres d'authentification et association au merchant.
                    </p>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Code unique pour identifier l'authentification (généré automatiquement si vide)</p>
                            @error('code')
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="username" id="username" value="{{ old('username') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm px-3 py-2 border border-gray-300 rounded-md">
                            @error('username')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('auths.index') }}" class="bg-white py-2 px-4 border px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Annuler
            </a>
