...
@section('title', 'Nouvelle Configuration - SMS Gateway')
@section('header', 'Créer une Nouvelle Configuration SMS')

@section('content')
<div class="max-w-2xl mx-auto">
    <form method="POST" action="{{ route('configurations.store') }}" class="space-y-6">
        @csrf
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Paramètres généraux de la configuration SMS.
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <button type="button" onclick="generateCode('code', 'CONFIG_')" class="inline-flex items-center px-3 py-2 border border-l-0 px-3 py-2 border border-gray-300 rounded-r-md bg-gray-50 text-gray-500 text-sm hover:bg-gray-100">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                                    </svg>
                                </button>
                            </div>
                            <p class="mt-2 text-sm text-gray-500">Code unique pour identifier la configuration (généré automatiquement si vide)</p>
                            @error('code')
        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Configuration des paramètres de connexion SMS.
                    </p>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="url" name="sms_url" id="sms_url" value="{{ old('sms_url') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm px-3 py-2 border border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="url" name="sms_url_check" id="sms_url_check" value="{{ old('sms_url_check') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm px-3 py-2 border border-gray-300 rounded-md">
        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Configuration des paramètres de planification des envois.
                    </p>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-3">
                            ...
                            <input type="text" name="schedule_date_format" id="schedule_date_format" value="{{ old('schedule_date_format') }}" placeholder="Y-m-d H:i:s" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm px-3 py-2 border border-gray-300 rounded-md">
                        ...
                        <div class="col-span-3">
                            ...
                            <input type="text" name="schedule_date_value" id="schedule_date_value" value="{{ old('schedule_date_value') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm px-3 py-2 border border-gray-300 rounded-md">
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('configurations.index') }}" class="bg-white py-2 px-4 border px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Annuler
            </a>
