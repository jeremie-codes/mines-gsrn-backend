...
class DaipinSeeder extends Seeder
{
    public function run()
    {
        ...
        $fonctionChef = Fonction::where('name', 'Chef de Pool')->first();

        $poolsData = [
            ['name' => 'Bambala', 'chefs' => ['Mr Junior', 'Mr Justin']],
            ['name' => 'Secteur Agricole', 'chefs' => []],
            ['name' => 'Makaku Mbwa', 'chefs' => ['Maman Zizi']],
            ['name' => 'Poto Poto', 'chefs' => ['Mr Luc']],
            ['name' => 'Ebiko I', 'chefs' => ['Mr Eli']],
            ['name' => 'Ebiko II', 'chefs' => ['Mr Ardent']],
            ['name' => 'Bukanga Lonzo I', 'chefs' => ['Mr Mbuta']],
            ['name' => 'Bukanga Lonzo II', 'chefs' => []],
            ['name' => 'Parc', 'chefs' => ['Maman Mado']],
            ['name' => 'Likana I', 'chefs' => ['Mr Crispin']],
            ['name' => 'Likana II', 'chefs' => ['Mr Andunga']],
            ['name' => 'Vuku Vuku', 'chefs' => ['Mr Nool']],
            ['name' => 'Pisciculture I', 'chefs' => ['Mme Mireille']],
            ['name' => 'Pisciculture II', 'chefs' => []],
            ['name' => 'Couvoirs', 'chefs' => ['Mr Olivier Ngesimi']],
            ['name' => 'V.A.B', 'chefs' => ['Mr Alpha']],
            ['name' => 'Antenne', 'chefs' => ['Mr Coralie']],
            ['name' => 'Bambou', 'chefs' => ['Pélagie']],
            ['name' => 'Mukuna', 'chefs' => ['Gorethie']],
            ['name' => 'Jules', 'chefs' => ['Romain']],
        ];
        ...
        foreach ($poolsData as $poolData) {
            ...
            foreach ($poolData['chefs'] as $chefName) {
                Member::create([
                    'firstname' => $chefName,
                    'lastname' => null,
                    'membershipNumber' => strtoupper('DPN-' . Str::random(5)),
                    'site_id' => $site->id,
                    'pool_id' => $pool->id,
                    'libelle_pool' => null,
                    'fonction_id' => $fonctionChef?->id,
                    'is_active' => true,
                    'date_adhesion' => now(),
                ]);
            }
        ...
        $this->command->info("✅ Pools et Chefs de Pool de DAIPIN créés avec succès.");
    }
}
